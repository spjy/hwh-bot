    ...
    */
    ...
    if (content.startsWith('&') && channel.id === '425573787950514177') {
      ...
      if (!roleExists) {
        ...
        member.guild.channels.get('411828103321485313')
          .send(suggestion).then(msg => {
            msg.react('😁');
            msg.react('❌');
    ...
    if (message.mentions.roles && channel.id !== '446051447226761216' && author.id !== '274437921183105034') { 
      ...
      if (report.includes('276969339901444096')) { // If mentions include @HWH Staff
        ...
        message.guild.channels.get('446051447226761216') // Send information to report channel
          .send(
            '', 
            { 
              embed: {
...
client.on('messageReactionAdd', (reaction, user) => {
  ...
  if (message.channel.id === '411828103321485313') {
    ...
    if (emoji.name === '😁' && message.client.user.id !== user.id) {
      ...
      message
        .delete();
      message.guild.channels.get('411828103321485313')
        .send(`Added ${content} role.`);
      message.guild.channels.get('425573787950514177')
